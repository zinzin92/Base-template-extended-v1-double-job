...
AddEventHandler('esx_basicneeds:onDrink', function(prop_name)
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			...
			local prop = CreateObject(GetHashKey(prop_name), x, y, z + 0.2, true, true, true)
			local boneIndex = GetPedBoneIndex(playerPed, 18905)
			AttachEntityToEntity(prop, playerPed, boneIndex, 0.12, 0.001, 0.021, -90.0, 175.0, 0.0, true, true, false, true, 1, true)
...
RegisterNetEvent('esx_basicneeds:onDrinkS')
AddEventHandler('esx_basicneeds:onDrinkS', function(prop_name)
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			local playerPed = PlayerPedId()
			local x,y,z = table.unpack(GetEntityCoords(playerPed))
			local prop = CreateObject(GetHashKey(prop_name), x, y, z + 0.0, true, true, true)
			local boneIndex = GetPedBoneIndex(playerPed, 18905)
			AttachEntityToEntity(prop, playerPed, boneIndex, 0.12, 0.028, 0.021, -90.0, 175.0, 0.0, true, true, false, true, 1, true)
