Locales['fr'] = {
  ...
  ['eye_squint'] = 'strabisme des yeux',
  ['eyebrow_type'] = 'type de sourcil',
  ['eyebrow_size'] = 'la taille des sourcils',
  ['eyebrow_color_1'] = 'la couleur des sourcils 1',
  ['eyebrow_color_2'] = 'la couleur des sourcils 2',
  ...
  ['bodyb_extra'] = 'effet corporel imperfections',
  ['bodyb_extra_thickness'] = "imperfections épaisseur corps",
}
