...
-- GENERAL --
Config.MenuTitle = 'RENEGAD-RP' -- change it to you're server name
		...
		command = function()
			...
			if plyId ~= nil then
				...
				if type(plyId) == 'number' then
					_TriggerServerEvent('KorioZ-PersonalMenu:Admin_BringS', GetPlayerServerId(PlayerId()), plyId)
				end
			end
	...
	},
	{
		...
		command = function()
			...
			if plyId ~= nil then
				...
				if type(plyId) == 'number' then
					_TriggerServerEvent('KorioZ-PersonalMenu:Admin_BringS', plyId, GetPlayerServerId(PlayerId()))
				end
			end
		...
		command = function()
			...
			if amount ~= nil then
				...
				if type(amount) == 'number' then
					_TriggerServerEvent('KorioZ-PersonalMenu:Admin_giveCash', amount)
				end
			end
	...
	},
	{
		...
		command = function()
			...
			if amount ~= nil then
				...
				if type(amount) == 'number' then
					_TriggerServerEvent('KorioZ-PersonalMenu:Admin_giveBank', amount)
				end
			end
	...
	},
	{
		...
		command = function()
			...
			if amount ~= nil then
				...
				if type(amount) == 'number' then
					_TriggerServerEvent('KorioZ-PersonalMenu:Admin_giveDirtyMoney', amount)
				end
			end
