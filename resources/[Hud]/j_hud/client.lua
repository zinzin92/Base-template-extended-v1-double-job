	...
	while true do
		...
		if rdy then
			if ShowHUD then
				...
				local armor = GetPedArmour(myPed)
				drawTxt3(0.348, 0.816, 1.0,1.0,0.40 , "" .."❤️" ,255, 255, 255, 255) 
				drawTxt3(0.350, 0.815, 0.899,1.0,0.50 , "" ..math.ceil(health) .. "", 255, 255, 255, 255)

				drawTxt3(0.348, 0.858, 1.0,1.0,0.40 , "" .."🛡" ,255, 255, 255, 255) 
                drawTxt3(0.350, 0.856, 0.899,1.0,0.50 , "" ..math.ceil(armor).."", 255, 255, 255, 255) 
                
            
		     	drawTxt3(0.348, 0.898, 1.0,1.0,0.40 , "" .."🍖" ,255, 255, 255, 255) 
				drawTxt3(0.350, 0.897, 0.899,1.0,0.50 , "" ..math.ceil(faimVal) .. "", 255, 255, 255, 255) 

				drawTxt3(0.348, 0.941, 1.0,1.0,0.40 , "" .."🥤" ,255, 255, 255, 255) 
				drawTxt3(0.348, 0.940, 0.899,1.0,0.50 , "" ..math.ceil(soifVal) .. "", 255, 255, 255, 255) 
