Config.Jobs.miner = {
	...
	Zones = {
		...
		Mine = {
			Pos = {x = -595.51, y = 2085.97, z = 131.4},
		...
		Foundry = {
			Pos = {x = 1089.33, y = -2000.29, z = 30.87},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
			Blip = true,
		...
		CopperDelivery = {
			Pos = {x = 895.53, y = -2485.15, z = 28.45},
			Color = {r = 204, g = 204, b = 0},
		...
		IronDelivery = {
			Pos = {x = 928.86, y = -2487.79, z = 28.45},
			Color = {r = 204, g = 204, b = 0},
			Size = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
