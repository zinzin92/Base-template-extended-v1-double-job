Locales['fr'] = {
  ...
  ['command_setjob2'] = 'assigner job à un joueur',
  ['command_setjob2_job'] = 'nom du job',
  ['command_setjob2_grade'] = 'grade du job',
  ['command_setjob2_invalid'] = 'le job, le grade ou les deux sont invalides',
  ...
  ['weapon_flashbang'] = 'Grenade flash',
  ['weapon_lgcougar'] = 'Lance grenade gas',
  ['weapon_lbd'] = 'Flashball',
  ['weapon_gazeuse'] = 'gazeuse',
