...
Config.Weapons = {
	...
	{name = 'WEAPON_FLASHBANG', label = _U('weapon_flashbang'), components = {}},
	{name = 'WEAPON_LGCOUGAR', label = _U('weapon_lgcougar'), components = {}},
	{name = 'WEAPON_LBD', label = _U('weapon_lbd'), components = {}},
	{name = 'WEAPON_GAZEUSE', label = _U('weapon_gazeuse'), components = {}},
