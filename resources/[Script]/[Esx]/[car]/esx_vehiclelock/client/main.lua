	...
	ESX.TriggerServerCallback('esx_vehiclelock:mykey', function(gotkey)
		...
		if gotkey then
			...
			if locked == 1 or locked == 0 then -- if unlocked
				...
				--ESX.ShowNotification(('Clé'), ("de voiture"), ("Vous avez ~r~fermé~s~ le véhicule."), 'CHAR_PEGASUS_DELIVERY', 1, 2)
			elseif locked == 2 then -- if locked
				...
				--ESX.ShowNotification(('Clé'), ("de voiture"), ("Vous avez ~g~ouvert~s~ le véhicule."), 'CHAR_PEGASUS_DELIVERY', 1, 2)
			end
		else
			ESX.ShowNotification("~r~Vous n'avez pas les clés de ce véhicule.")
			--ESX.ShowNotification(('Clé'), ("de voiture"), ("Vous n'avez pas les clés de ce véhicule."), 'CHAR_PEGASUS_DELIVERY', 1, 2)
		end
